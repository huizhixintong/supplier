...
public class ErrCode {
    ...
    public final static int ERR_FOREIGN_KEY_NULL = 1000004;
    ...
    private final static String ERR_FOREIGN_KEY_NULL_MSG = "外键ID为空";
    ...
    public static String getErrMsg(int code){
        switch (code){
            ...
            case ERR_FOREIGN_KEY_NULL:
                return ERR_FOREIGN_KEY_NULL_MSG;
            default:
