...
public interface TVcsCompanyEvaluateScoreMapper {
     ...
     * @mbg.generated
     */
    TVcsCompanyEvaluateScoreWithBLOBs selectByPrimaryKeySelective(@Param("id") String id, @Param("selective") TVcsCompanyEvaluateScoreWithBLOBs.Column ... selective);
     ...
     * @mbg.generated
     */
    TVcsCompanyEvaluateScoreWithBLOBs selectByPrimaryKey(String id);
