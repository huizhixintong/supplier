...
public interface TCpyLegalRoomMapper {
     ...
     * @mbg.generated
     */
    TCpyLegalRoom selectByPrimaryKeySelective(@Param("id") Integer id, @Param("selective") TCpyLegalRoom.Column ... selective);
     ...
     * @mbg.generated
     */
    TCpyLegalRoom selectByPrimaryKey(Integer id);
