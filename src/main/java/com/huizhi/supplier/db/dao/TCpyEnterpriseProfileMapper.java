...
public interface TCpyEnterpriseProfileMapper {
     ...
     * @mbg.generated
     */
    TCpyEnterpriseProfile selectByPrimaryKeySelective(@Param("id") String id, @Param("selective") TCpyEnterpriseProfile.Column ... selective);
     ...
     * @mbg.generated
     */
    TCpyEnterpriseProfile selectByPrimaryKey(String id);
