...
public interface TCpyAuthenticationMapper {
     ...
     * @mbg.generated
     */
    TCpyAuthentication selectByPrimaryKeySelective(@Param("id") String id, @Param("selective") TCpyAuthentication.Column ... selective);
     ...
     * @mbg.generated
     */
    TCpyAuthentication selectByPrimaryKey(String id);
