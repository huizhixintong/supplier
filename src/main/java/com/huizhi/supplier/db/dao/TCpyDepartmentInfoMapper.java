...
public interface TCpyDepartmentInfoMapper {
     ...
     * @mbg.generated
     */
    TCpyDepartmentInfo selectByPrimaryKeySelective(@Param("id") String id, @Param("selective") TCpyDepartmentInfo.Column ... selective);
     ...
     * @mbg.generated
     */
    TCpyDepartmentInfo selectByPrimaryKey(String id);
