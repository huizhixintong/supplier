...
public interface TCpyQualificationMapper {
     ...
     * @mbg.generated
     */
    TCpyQualification selectByPrimaryKeySelective(@Param("id") Integer id, @Param("selective") TCpyQualification.Column ... selective);
     ...
     * @mbg.generated
     */
    TCpyQualification selectByPrimaryKey(Integer id);
