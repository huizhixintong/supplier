...
public interface TCpyFlangingRegulationCheckMapper {
     ...
     * @mbg.generated
     */
    TCpyFlangingRegulationCheck selectByPrimaryKeySelective(@Param("id") Integer id, @Param("selective") TCpyFlangingRegulationCheck.Column ... selective);
     ...
     * @mbg.generated
     */
    TCpyFlangingRegulationCheck selectByPrimaryKey(Integer id);
