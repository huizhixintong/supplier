...
public interface TCpyScienceInnovationMapper {
     ...
     * @mbg.generated
     */
    TCpyScienceInnovation selectByPrimaryKeySelective(@Param("id") String id, @Param("selective") TCpyScienceInnovation.Column ... selective);
     ...
     * @mbg.generated
     */
    TCpyScienceInnovation selectByPrimaryKey(String id);
