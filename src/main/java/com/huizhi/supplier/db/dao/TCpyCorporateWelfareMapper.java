...
public interface TCpyCorporateWelfareMapper {
     ...
     * @mbg.generated
     */
    TCpyCorporateWelfare selectByPrimaryKeySelective(@Param("id") String id, @Param("selective") TCpyCorporateWelfare.Column ... selective);
     ...
     * @mbg.generated
     */
    TCpyCorporateWelfare selectByPrimaryKey(String id);
