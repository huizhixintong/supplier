...
public interface TCpyBankCreditMapper {
     ...
     * @mbg.generated
     */
    TCpyBankCredit selectByPrimaryKeySelective(@Param("id") String id, @Param("selective") TCpyBankCredit.Column ... selective);
     ...
     * @mbg.generated
     */
    TCpyBankCredit selectByPrimaryKey(String id);
